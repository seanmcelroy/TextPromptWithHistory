...
public sealed class TextPromptTests
{
    ...
    public void Should_Return_Entered_Text()
    {
        ...
        // When
        var result = console.Prompt(new TextPromptWithHistory<string>("Enter text:"));
    ...
    public Task Should_Return_Validation_Error_If_Value_Cannot_Be_Converted()
    {
        ...
        // When
        console.Prompt(new TextPromptWithHistory<int>("Age?"));
    ...
    public Task Should_Chose_Default_Value_If_Nothing_Is_Entered()
    {
        ...
        // When
        console.Prompt(
            new TextPromptWithHistory<string>("Favorite fruit?")
                .AddChoice("Banana")
                .AddChoice("Orange")
                .DefaultValue("Banana"));
    ...
    public Task Should_Return_Error_If_Custom_Validation_Fails()
    {
        ...
        // When
        console.Prompt(
            new TextPromptWithHistory<int>("Guess number:")
    ...
    public Task Should_Use_Custom_Converter()
    {
        ...
        var result = console.Prompt(
            new TextPromptWithHistory<(int, string)>("Favorite fruit?")
                .AddChoice((1, "Apple"))
                .AddChoice((2, "Banana"))
    ...
    public Task Should_Not_Append_Questionmark_Or_Colon_If_No_Choices_Are_Set()
    {
        ...
        // When
        console.Prompt(
            new TextPromptWithHistory<string>("Enter command$"));
    ...
    public Task Uses_default_style_for_default_value_if_no_style_is_set()
    {
        ...
        var prompt = new TextPromptWithHistory<string>("Enter Value:")
                .ShowDefaultValue()
    ...
    public Task UpArrow_with_one_history_retrieves_it()
    {
        ...
        // When
        console.Prompt(
            new TextPromptWithHistory<string>("Favorite fruit?").AddHistory(history));
